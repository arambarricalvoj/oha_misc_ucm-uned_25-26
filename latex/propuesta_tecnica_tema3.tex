...
arquitectura de dos niveles para reducir la dimensionalidad efectiva y filtrar soluciones
...
actual con el mutante basado en una probabilidad $CR$.
    \item \textbf{Selección/Recombinación:} selección elitista 1 a 1, donde el hijo 
