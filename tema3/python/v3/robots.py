...
from kinematics import manipulability_xarm6


# ssik IK solvers (instancias preconstruidas)
ikA_solver = xarm6_ik
ikB_solver = xarm6_ik
...
def _extract_q_list(sols):
    """
    Convierte la salida de ssik (lista de objetos Solution)
    en una lista de vectores articulares numpy.
    """
    if sols is None:
        return []
